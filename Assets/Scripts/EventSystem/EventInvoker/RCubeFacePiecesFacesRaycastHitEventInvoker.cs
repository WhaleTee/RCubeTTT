...
/// </summary>
public interface RCubeFacePiecesFacesRaycastHitEventInvoker : Invoker<RCubeFacePiecesFacesRaycastHitEventContext>, EventProvider<RCubeFacePiecesFaceRaycastHitEvent> {
  /// <summary>
